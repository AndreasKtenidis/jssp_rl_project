...
for epoch in range(num_epochs):
    ...
    if episode_makespans and losses:
        ...
        print("⚠️ No makespan or loss returned from train_loop. Skipping log.")
...
plot_gantt_chart(env.extract_job_assignments(), save_path=os.path.join(base_dir, "gantt_chart.html"))
...
rl_script_path = os.path.join(base_dir, "eval", "main_test.py")
