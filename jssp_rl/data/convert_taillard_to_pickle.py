...
def convert_all_taillard(txt_folder):
    save_path = os.path.join("saved", "Synthetic_instances_15x15_5000.pkl")
    instances = []
...
if __name__ == "__main__":
    convert_all_taillard("C:/Users/andre/Desktop/Results JSSP/Synthetic_data_5000/Synthetic_15x15/generated_instances_5000x15")