...
class RolloutBuffer:
    ...
    def compute_returns_and_advantages(self, last_value, gamma=0.99, gae_lambda=0.95):
        """
        Standard GAE(lambda) on raw rewards/values.
        ...
        for step in reversed(range(len(self.rewards))):
            ...
            gae = delta + gamma * gae_lambda * (1 - float(done)) * gae
    ...
    def get_batches(self, batch_size: int):
        ...
        for start in range(0, total_size, batch_size):
            ...
            # Sanity: mask/penalty lengths must match #op nodes in the batch
            ...
            yield (
                batch_data,             # HeteroData (CPU; will be moved to device during training)
                actions_batch,          # [B]
